...
plot(datetime, a1$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering",col="green",ylim=c(0,40))
par(new=TRUE)
plot(datetime, a1$Sub_metering_2, type="l", xlab="", ylab="",col="red",ylim=c(0,40))
par(new=TRUE)
plot(datetime, a1$Sub_metering_3, type="l", xlab="", ylab="",col="blue",ylim=c(0,40))
